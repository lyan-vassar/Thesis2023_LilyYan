/* NOT FINISHED (tentative)
    combination of one var per category (tentative, probably won't do)
    motor 2 + sem 1 + task 1
    letter keys + reversed semantics + platform sequence win condition
*/
