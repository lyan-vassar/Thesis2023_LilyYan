...
function startSurvey3() {
    ...
    window.requestAnimationFrame(gameLoopSurvey3);
}
...
function gameLoopSurvey3(timeStamp) {
    // render everything
    renderCanvas3();
    renderPlayer3();
    renderDoor3();
    ...
    if (victoryCondition || !isPlayerAlive || isOver) gameOverSurvey3();

    else window.requestAnimationFrame(gameLoopSurvey3);
}
...
var reversedSemLevelSurvey = { // need start, render, gameloop?, end
